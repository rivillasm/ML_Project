...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            logging.info(f"Obtaining training/testing file path.")
            train_file_path = self.data_ingestion_artifact.train_file_path
            test_file_path = self.data_ingestion_artifact.test_file_path
            schema_file_path = self.data_validation_artifact.schema_file_path

            logging.info(f"Loading training/testing data as pandas dataframe.")
            ...
            transformed_train_dir = self.data_transformation_config.transformed_train_dir  # gets the directory
            transformed_test_dir = self.data_transformation_config.transformed_test_dir
            train_file_name = os.path.basename(train_file_path).replace(".csv", ".npz")  # gets the file name
            test_file_name = os.path.basename(test_file_path).replace(".csv", ".npz")
            transformed_train_file_path = os.path.join(transformed_train_dir, train_file_name)  # full path
            transformed_test_file_path = os.path.join(transformed_test_dir, test_file_name)

            logging.info(f"Saving transformed training/testing arrays.")
